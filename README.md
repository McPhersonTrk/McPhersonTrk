...
If you read: eight + twenty ÷ five * four, right?

You applied PEDMAS: and got,
8 + 5 * 4 =
8 + 20 = 28. right?
Nope, you translated that problem wrong.

If you forgot about PEDMAS and went left to right, you came up with  28 ÷ 5 * 4 = 5.6 * 4 = 22.4.
Nope, that isn’t right, either.

This math problem, properly translated into English reads:
...
Now, translate it into English… see it yet? 
